...
(function ($) {
  ...
  var $flat_sidebar_container = $('<div />', { class: 'mb-1' }).append($flat_sidebar_checkbox).append('<span>Estilo plano de navegación de barra lateral</span>')
  ...
  var $legacy_sidebar_container = $('<div />', { class: 'mb-1' }).append($legacy_sidebar_checkbox).append('<span>Estilo heredado de navegación de la barra lateral</span>')
  ...
  var $child_hide_sidebar_container = $('<div />', { class: 'mb-1' }).append($child_hide_sidebar_checkbox).append('<span>El niño de navegación de la barra lateral se oculta al contraer</span>')
  ...
  var $text_sm_brand_container = $('<div />', { class: 'mb-1' }).append($text_sm_brand_checkbox).append('<span>Texto pequeño de la marca</span>')
  ...
  var $clear_btn = $('<a />', {
    href: '#'
  }).text('Limpiar').on('click', function (e) {
    e.preventDefault()
    var $logo = $('.brand-link')
