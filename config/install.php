...
<script>
  input_size.oninput = function() {
    result.innerHTML = input_size.value;
    var b = document.getElementById("size_input");
            b.setAttribute("class", "col-"+input_size.value);
  };
  </script>
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    <label for="">Sevidor</label>
                    <input type="text" class="form-control" id="servidor" placeholder="Localhost" name="servidor" value="Localhost">
                  </div>
                  <div class="form-group">
                    <label for="">Usuario</label>
                    <input type="text" name="usuario" class="form-control" id="usuario" placeholder="root" value="root">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Contraseña</label>
                    <input name="clave" type="password" class="form-control" id="exampleInputPassword1" placeholder="Clave">
                  </div>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Dev</label>
                    <div class="col-sm-10">
                      
                      <input name="desarrollador" type="text" class="form-control" id="desarrollador" placeholder="Nombre">
                    </div>
                  </div>
                  <div class="form-group row">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Tamaño de Input(Min:3,Max:12)</h3>
              </div>
              <div class="card-body">
                <div class="row">
                  <div id="size_input" class="col-3">
                    <input name="input_size" id="input_size" onkeyup="tamaño()" onchange="tamaño()" type="number" min="3" max="12" class="form-control" placeholder=".col-3" value="3">
                    Class=.col-<span id="result">3</span>
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
              ...
              <div class="card-body">
                <form>
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label >Tiempo Notificación Registro <i class="fas fa-check"></i></label>
                        <input name="time_insert" value="1" type="number" class="form-control" placeholder="1" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
                      <!-- textarea -->
                      <div class="form-group">
                        <label>Tiempo Notificación Actualización <i class="far fa-bell"></i></label>
                        <input name="time_update" value="1" type="number" class="form-control" placeholder="1" >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <!-- textarea -->
                      <div class="form-group">
                        <label>Tiempo Notificación Eliminación  <label class="col-form-label" for="inputError"><i class="far fa-times-circle"></i></label>
                        <input name="time_delete" value="1" type="number" class="form-control" placeholder="1" >
                      </div>
                    </div>
                  </div>
